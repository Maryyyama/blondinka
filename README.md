...
<div align="center">
  ...
  **Студентка | Начинающий Frontend-разработчик | UI/UX enthusiast**
...
Я студентка из Астрахани, которая решила покорить IT. Учусь совмещать учёбу в вузе, самообучение и поиск первой работы. Моя цель - стать крутым специалистом и работать удаленно.

- 🌱 Сейчас изучаю: **JavaScript, React, HTML/CSS, Node.js**
- 🎨 Параллельно осваиваю: **UI/UX дизайн, Figma, PhotoShop, IlIistrator**
...
| **Дизайн** | ![Figma](https://img.shields.io/badge/-Figma-F24E1E?style=flat-square&logo=figma&logoColor=white) |
...
> *Здесь будут появляться мои работы. Пока учусь — делаю маленькие шаги.*
...
[![Telegram](https://img.shields.io/badge/-Telegram-26A5E4?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/maryyyama)
...
[![Gmail](https://img.shields.io/badge/-Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](emae.masulka52@mail.com)
